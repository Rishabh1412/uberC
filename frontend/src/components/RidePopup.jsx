...
const RidePopup = (props) => {
  return (
    <div className="">
      ...
      <h3 className="px-4 font-semibold text-2xl mt-4">New Ride Available</h3>
      <div className="flex px-4 items-center mt-4 mx-4 bg-gray-200 p-3 rounded-lg justify-between">
      ...
      <div className=" flex flex-col justify-between items-center">
        <div className="w-full gap-4 mb-7 pb-4 flex flex-col">
          <div className="flex px-4 gap-3 pt-4 items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="currentColor"
          ...
          <div className="flex px-4 gap-3 border-t-2 pt-4 items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
        ...
        <div className="w-screen px-4 gap-4 flex">
          <button
            className="bg-gray-300 text-gray-800  w-1/2 rounded-lg font-semibold p-2"
            onClick={() => {
                props.setRidePopupPanel(false)
            }}
          >
          ...
          <button onClick={()=>{props.setConfirmRidePopupPanel(true)}} className=" bg-green-600 w-1/2 font-semibold text-white p-2 rounded-lg">
            Accept
          </button>
        </div>
      </div>
