...
const ConfirmRidePopup = (props) => {
  ...
  return (
    <div className="">
      ...
      <h3 className="px-4 font-semibold text-2xl">Confirm this rode</h3>
        ...
        <div className="w-screen px-4 flex gap-4">
          ...
          >
            ...
            onChange={(e)=>{setOtp(e.target.value)}}
              type="text"
              className="bg-[#eee] px-12 font-mono py-4 mb-4 text-lg rounded-lg w-full mt-3"
            ...
            <div className="w-full flex gap-4">
              <button
                ...
                className="bg-red-500 w-1/2 font-semibold text-red-50 p-2 rounded-lg"
              >
                Cancel
              </button>
              <Link to="/captain-riding" className="w-1/2">
                <button
                  type="button"
                  className="bg-green-600 w-full font-semibold text-white p-2 rounded-lg"
                >
                  Confirm
                </button>
              </Link>
